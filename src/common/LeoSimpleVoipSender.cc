...
Define_Module(LeoSimpleVoipSender);

simsignal_t LeoSimpleVoipSender::packetSentSignal = registerSignal("packetSent");

LeoSimpleVoipSender::LeoSimpleVoipSender()
{
}
...
void LeoSimpleVoipSender::initialize(int stage)
{
...
void LeoSimpleVoipSender::handleMessage(cMessage *msg)
{
...
void LeoSimpleVoipSender::talkspurt(simtime_t dur)
{
...
void LeoSimpleVoipSender::selectTalkOrSilenceInterval()
{
...
void LeoSimpleVoipSender::sendVoIPPacket()
{
