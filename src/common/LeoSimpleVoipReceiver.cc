...
#include <cmath>
#include "LeoSimpleVoipReceiver.h"

namespace inet {

Define_Module(LeoSimpleVoipReceiver);

simsignal_t LeoSimpleVoipReceiver::voipPacketLossRateSignal = registerSignal("voipPacketLossRate");
simsignal_t LeoSimpleVoipReceiver::voipPacketDelaySignal = registerSignal("voipPacketDelay");
simsignal_t LeoSimpleVoipReceiver::voipPlayoutDelaySignal = registerSignal("voipPlayoutDelay");
simsignal_t LeoSimpleVoipReceiver::voipPlayoutLossRateSignal = registerSignal("voipPlayoutLossRate");
simsignal_t LeoSimpleVoipReceiver::voipMosRateSignal = registerSignal("voipMosRate");
simsignal_t LeoSimpleVoipReceiver::voipTaildropLossRateSignal = registerSignal("voipTaildropLossRate");
simsignal_t LeoSimpleVoipReceiver::packetReceivedSignal = registerSignal("packetReceived");

void LeoSimpleVoipReceiver::TalkspurtInfo::startTalkspurt(const SimpleVoipPacket *pk)
{
    status = ACTIVE;
...
bool LeoSimpleVoipReceiver::TalkspurtInfo::checkPacket(const SimpleVoipPacket *pk)
{
...
void LeoSimpleVoipReceiver::TalkspurtInfo::addPacket(const SimpleVoipPacket *pk)
{
...
LeoSimpleVoipReceiver::LeoSimpleVoipReceiver()
{
}
...
void LeoSimpleVoipReceiver::initialize(int stage)
{
...
void LeoSimpleVoipReceiver::startTalkspurt(Packet *packet)
{
...
void LeoSimpleVoipReceiver::handleMessage(cMessage *msg)
{
...
void LeoSimpleVoipReceiver::socketDataArrived(UdpSocket *socket, Packet *packet)
{
// TODO count
...
void LeoSimpleVoipReceiver::socketErrorArrived(UdpSocket *socket, Indication *indication)
{
    EV_WARN << "Unknown message '" << indication->getName() << "', kind = " << indication->getKind() << ", discarding it." << endl;
    delete indication;
}

void LeoSimpleVoipReceiver::evaluateTalkspurt(bool finish)
{
    ...
    if(std::isinf(packetLossRate)){
        std::cout << "talkNumPackets: " << talkspurtNumPackets << std::endl;
    }
...
double LeoSimpleVoipReceiver::eModel(double delay, double lossRate)
{
...
void LeoSimpleVoipReceiver::finish()
{
