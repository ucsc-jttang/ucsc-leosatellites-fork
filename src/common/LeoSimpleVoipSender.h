...
#ifndef __INET_LEOSIMPLEVOIPSENDER_H
#define __INET_LEOSIMPLEVOIPSENDER_H
 ...
 */
class INET_API LeoSimpleVoipSender : public cSimpleModule, public LifecycleUnsupported
{
  private:
    UdpSocket socket;
