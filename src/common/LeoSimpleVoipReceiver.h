...
#ifndef __INET_LEOSIMPLEVOIPRECEIVER_H
#define __INET_LEOSIMPLEVOIPRECEIVER_H
 ...
 */
class INET_API LeoSimpleVoipReceiver : public cSimpleModule, public LifecycleUnsupported, public UdpSocket::ICallback
{
  private:
